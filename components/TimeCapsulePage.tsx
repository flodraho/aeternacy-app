...
import { CheckCircle, Loader2, Share2, ArrowLeft } from 'lucide-react';
        ...
        return (
          <div className="min-h-[60vh] flex items-center justify-center">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold text-white font-brand">Crafting Your Legacy Letter</h2>
        ...
        return (
          <div className="w-full max-w-4xl mx-auto animate-fade-in-up">
            <header className="flex justify-between items-center mb-8">
              <div>
                <h1 className="text-4xl font-bold text-white font-brand">Your Time Capsule</h1>
        ...
        return (
          <div className="w-full">
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold text-white font-brand">Create Your Time Capsule</h1>
            ...
            <div className="sticky bottom-0 mt-8 py-4 bg-slate-900/80 backdrop-blur-sm flex justify-center items-center gap-4">
              ...
              >
                Create Legacy Letter ({TOKEN_COSTS.TIME_CAPSULE_SEAL} <span className="text-sm">Tokæn</span>)
              </button>
            </div>
          </div>
        );
